                    ...
                    <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                ...
                                <div class="col-sm-6">
                                    <img src="{{ URL::to('frontend/images/home/girl1.jpg') }}"
                                        class="girl img-responsive" alt="" />
                                    <img src="{{ URL::to('frontend/images/home/pricing.png') }}" class="pricing"
                                        alt="" />
                                </div>
                            </div>
                            <div class="item">
                                ...
                                <div class="col-sm-6">
                                    <img src="{{ URL::to('frontend/images/home/girl2.jpg') }}"
                                        class="girl img-responsive" alt="" />
                                    <img src="{{ URL::to('frontend/images/home/pricing.png') }}" class="pricing"
                                        alt="" />
                                </div>
                            ...
                            <div class="item">
                                ...
                                <div class="col-sm-6">
                                    <img src="{{ URL::to('frontend/images/home/girl3.jpg') }}"
                                        class="girl img-responsive" alt="" />
                                    <img src="{{ URL::to('frontend/images/home/pricing.png') }}" class="pricing"
                                        alt="" />
                                </div>
                            ...
                            @foreach ($all_category_info as $all_category)
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title"><a href="#">{{ $all_category->category_name }}</a>
                                        </h4>
                                    </div>
                                </div>
                            @endforeach
                        ...
                        <div class="brands_products">
                            ...
                            <div class="brands-name">
                                <ul class="nav nav-pills nav-stacked">
                                    <?php $all_manaufacture_info = DB::table('tbl_manaufacture')
                                    ->where('publication_status', 1)
                                    ->get(); ?>
                                    @foreach ($all_manaufacture_info as $all_manaufacture)
                                        <li><a href="#"> <span
                                                    class="pull-right">(50)</span>{{ $all_manaufacture->manaufacture_name }}</a>
                                        </li>
                                    @endforeach
                                </ul>
                            </div>
