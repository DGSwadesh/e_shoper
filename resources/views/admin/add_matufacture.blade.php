...
@endif
    ...
    <form action={{ url('/saveManufacture') }} method="post">
        @csrf
        <div class="form-group p-md-5">
            <div class="form-group row ">
                <label for="colFormLabelLg" class="col-sm-2 col-form-label">Manufacture Name</label>
                <div class="col-sm-6">
                    <input type="text" class="form-control" id="colFormLabelLg" placeholder="Manufacture name" name="manaufacture_name" required>
                </div>
            </div>
            <div class="form-group row ">
                <label for="colFormLabelLg" class="col-sm-2 col-form-label">Manufacture
                    description</label>
                <div class="col-sm-6">
                    <textarea class="form-control" id="exampleFormControlTextarea3" rows="7" name="manaufacture_description" required></textarea>
                </div>
            </div>
            <div class="form-group row ">
